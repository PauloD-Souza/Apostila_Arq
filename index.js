...
const headingText = "Olá, Seja bem-vindo a nossa aula de arquitetura de computadores :)";
const welcomeText = "Vamos Começar ;-;";
const subtitleText = "Residência Pedagogia 2022 - 2024";
let headingIndex = 0;
let welcomeIndex = 0;
let subtitleIndex = 0;
